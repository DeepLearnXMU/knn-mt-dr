...
DATA_PATH=$PROJECT_PATH/data-bin/$datastore
SAVE_DIR=$PROJECT_PATH/save-models/combiner/pck/$datastore'_dim64'
DATASTORE_LOAD_PATH=$PROJECT_PATH/datastore/pck/$datastore'_dim64'
MAX_K=8
case $dataset in
koran)
    temperature=100
...
--knn-temperature-type fixed --knn-temperature $temperature \
