...
def add_generation_args(parser):
    ...
    # arguments for el-knnmt
    group.add_argument('--is-el-knnmt', action='store_true', default=False)
    group.add_argument('--freq-path', type=str, default=None)
    group.add_argument('--fert-path', type=str, default=None)
